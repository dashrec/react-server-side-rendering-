...
exports.default = [_extends({}, _App2.default, { // always display on the screen and wrap is to children
...
// to use async await babel needs some helpers to be executed
...
'/api', (0, _expressHttpProxy2.default)('http://react-ssr-api.herokuapp.com', {
...
var _usersReducer = __webpack_require__(11);

var _usersReducer2 = _interopRequireDefault(_usersReducer);

var _authReducer = __webpack_require__(12);

var _authReducer2 = _interopRequireDefault(_authReducer);

var _adminsReducer = __webpack_require__(13);
...
//named export so we have to set curly breaks
...
function loadData(store) {
  ...
  return store.dispatch((0, _actions.fetchUsers)()); //set return to get back this req in index file
}
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(Header); // now header comp should receive a prop auth
